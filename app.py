...
<div class="main-header">
    ...
    <p>Tác giả: Hoàng Thị Quyên- Trường Tiểu học Nà Chì - ĐT:0911038233</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Hoàng Thị Quyên - Trường Tiểu học Nà Chì- ĐT: 0911038233</div>", unsafe_allow_html=True)
